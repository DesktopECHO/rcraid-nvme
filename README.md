...
### Fedora/Debian Installation for Existing Systems
...
Produces `rcraid-nvme.x86_64.rpm` (RPM) or `rcraid-nvme-1_amd64.deb` (DEB) and installs the package automatically.

## Installation Guide for Live CD Environments
